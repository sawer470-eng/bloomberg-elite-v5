...
An inverted 10Y-3M spread has historically preceded every US recession since 1970.
    ...
    banks = {
        "FED (USA)": {"rate": "5.50%", "next": "2024-05-01", "sentiment": "Hawkish"},
        "ECB (EU)": {"rate": "4.50%", "next": "2024-06-06", "sentiment": "Neutral"},
        "BoE (UK)": {"rate": "5.25%", "next": "2024-05-09", "sentiment": "Dovish"},
        "BoJ (Japan)": {"rate": "0.10%", "next": "2024-04-26", "sentiment": "Pivot"}
    }
