...
def render_ai_intelligence():
    ...
    default_key = "AIzaSyCwVZHb7ZsY8S9KE_PYszys6j_D8K2S3ZU"
    api_key = st.sidebar.text_input("Enter Gemini API Key", value=default_key, type="password", help="Get your key at aistudio.google.com")
